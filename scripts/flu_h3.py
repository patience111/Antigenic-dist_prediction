...
def parse_args():
    ...
    parser.add_argument('--namespace', type=str, default='fluh3',
...
def setup(args):
    fnames = [ "./data/allh3.fasta" ] #relative path to the data for retrain the model, may change this to your own data dir
    meta_fnames = [ "./data/allh3.tsv" ]
...
def seq_clusters(adata):
    ...
    for cluster in clusters:
        ...
        with open('fluh3/flu/clusters/cluster{}.fa'.format(cluster), 'w') as of:
